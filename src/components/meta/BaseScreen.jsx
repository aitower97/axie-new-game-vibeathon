...
const NAV = [
  { route: 'pve', icon: '🤖', title: 'PVE · Mapa de Lunacia', text: 'Regiones, nodos y esencia por victoria.' },
  { route: 'pvp', icon: '🏆', title: 'PVP · Arenas', text: 'Duelos contra axies normales de la comunidad.' },
  { route: 'evolucion', icon: '🔧', title: 'Laboratorio', text: 'Evoluciona partes y bloquea caras del dado.' },
  { route: 'investigacion', icon: '🔬', title: 'Investigacion', text: 'El detalle del genoma y las mejoras.' },
  { route: 'recursos', icon: '⚖', title: 'Recursos', text: 'La economia de sesion del puesto.' },
]
    ...
    >
      <div className="hub3">
        <div className="hub3-rail">
          {NAV.map((n) => (
            <button key={n.route} type="button" className="hub3-card" onClick={() => navigate(n.route)}>
          ...
          <button type="button" className="hub3-card hub3-play" onClick={() => onPlay()}>
            <span className="hub3-card-icon" aria-hidden="true">
              ⚔
            </span>
            <span className="hub3-card-text">
